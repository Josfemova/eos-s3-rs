#[doc = "Register `CS_CLK_GATE` reader"]
pub struct R(crate::R<CS_CLK_GATE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CS_CLK_GATE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CS_CLK_GATE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CS_CLK_GATE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CS_CLK_GATE` writer"]
pub struct W(crate::W<CS_CLK_GATE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CS_CLK_GATE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CS_CLK_GATE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CS_CLK_GATE_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Gating control for SWD CS clock U\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cs_clk_gate](index.html) module"]
pub struct CS_CLK_GATE_SPEC;
impl crate::RegisterSpec for CS_CLK_GATE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cs_clk_gate::R](R) reader structure"]
impl crate::Readable for CS_CLK_GATE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cs_clk_gate::W](W) writer structure"]
impl crate::Writable for CS_CLK_GATE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CS_CLK_GATE to value 0"]
impl crate::Resettable for CS_CLK_GATE_SPEC {
    #[inline(always)]
