#[doc = "Register `C02_CLK_GATE` reader"]
pub struct R(crate::R<C02_CLK_GATE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C02_CLK_GATE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C02_CLK_GATE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C02_CLK_GATE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C02_CLK_GATE` writer"]
pub struct W(crate::W<C02_CLK_GATE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C02_CLK_GATE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C02_CLK_GATE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C02_CLK_GATE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "To A1 (including CFGSM)\n\nValue on reset: 1"]
...
#[doc = "Field `Path_0_Gating_Control` reader - To A1 (including CFGSM)"]
...
#[doc = "Field `Path_0_Gating_Control` writer - To A1 (including CFGSM)"]
...
#[doc = "Field `Path_1_Gating_Control` reader - To FB"]
pub type PATH_1_GATING_CONTROL_R = PATH_0_GATING_CONTROL_R;
#[doc = "Field `Path_1_Gating_Control` writer - To FB"]
...
#[doc = "Field `Path_2_Gating_Control` reader - Not specified"]
pub type PATH_2_GATING_CONTROL_R = PATH_0_GATING_CONTROL_R;
#[doc = "Field `Path_2_Gating_Control` writer - Not specified"]
...
impl R {
    #[doc = "Bit 0 - To A1 (including CFGSM)"]
    #[inline(always)]
...
#[doc = "Gating control for Clock 2\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c02_clk_gate](index.html) module"]
pub struct C02_CLK_GATE_SPEC;
impl crate::RegisterSpec for C02_CLK_GATE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c02_clk_gate::R](R) reader structure"]
impl crate::Readable for C02_CLK_GATE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c02_clk_gate::W](W) writer structure"]
impl crate::Writable for C02_CLK_GATE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets C02_CLK_GATE to value 0x05"]
impl crate::Resettable for C02_CLK_GATE_SPEC {
    #[inline(always)]
