#[doc = "Register `CLK_CTRL_H_1` reader"]
pub struct R(crate::R<CLK_CTRL_H_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CLK_CTRL_H_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CLK_CTRL_H_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CLK_CTRL_H_1_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "For Clock 19 (ADC)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [clk_ctrl_h_1](index.html) module"]
pub struct CLK_CTRL_H_1_SPEC;
impl crate::RegisterSpec for CLK_CTRL_H_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [clk_ctrl_h_1::R](R) reader structure"]
impl crate::Readable for CLK_CTRL_H_1_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CLK_CTRL_H_1 to value 0"]
impl crate::Resettable for CLK_CTRL_H_1_SPEC {
    #[inline(always)]
