#[doc = "Register `CLK_CTRL_B_0` reader"]
pub struct R(crate::R<CLK_CTRL_B_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CLK_CTRL_B_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CLK_CTRL_B_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CLK_CTRL_B_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CLK_CTRL_B_0` writer"]
pub struct W(crate::W<CLK_CTRL_B_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CLK_CTRL_B_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CLK_CTRL_B_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CLK_CTRL_B_0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "For Clock 2 (FB, A1 (Including CFGSM))\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [clk_ctrl_b_0](index.html) module"]
pub struct CLK_CTRL_B_0_SPEC;
impl crate::RegisterSpec for CLK_CTRL_B_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [clk_ctrl_b_0::R](R) reader structure"]
impl crate::Readable for CLK_CTRL_B_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [clk_ctrl_b_0::W](W) writer structure"]
impl crate::Writable for CLK_CTRL_B_0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CLK_CTRL_B_0 to value 0x0204"]
impl crate::Resettable for CLK_CTRL_B_0_SPEC {
    #[inline(always)]
