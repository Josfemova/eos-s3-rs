#[doc = "Register `C09_CLK_DIV` reader"]
pub struct R(crate::R<C09_CLK_DIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C09_CLK_DIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C09_CLK_DIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C09_CLK_DIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C09_CLK_DIV` writer"]
pub struct W(crate::W<C09_CLK_DIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C09_CLK_DIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C09_CLK_DIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C09_CLK_DIV_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Source Clock is C10 (CLK to Voice APB interface, PIF, FB). If Bit 4 is 0, any change on Bit 3:0 will not take effect. And bit 4 and bit 3:0 can not change at same time.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c09_clk_div](index.html) module"]
pub struct C09_CLK_DIV_SPEC;
impl crate::RegisterSpec for C09_CLK_DIV_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c09_clk_div::R](R) reader structure"]
impl crate::Readable for C09_CLK_DIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c09_clk_div::W](W) writer structure"]
impl crate::Writable for C09_CLK_DIV_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets C09_CLK_DIV to value 0x11"]
impl crate::Resettable for C09_CLK_DIV_SPEC {
    #[inline(always)]
