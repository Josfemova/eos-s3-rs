#[doc = "Register `C21_CLK_GATE` reader"]
pub struct R(crate::R<C21_CLK_GATE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C21_CLK_GATE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C21_CLK_GATE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C21_CLK_GATE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C21_CLK_GATE` writer"]
pub struct W(crate::W<C21_CLK_GATE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C21_CLK_GATE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C21_CLK_GATE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C21_CLK_GATE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "To FB (additional CLK)\n\nValue on reset: 0"]
...
#[doc = "Field `Path_0_Gating_Control` reader - To FB (additional CLK)"]
...
#[doc = "Field `Path_0_Gating_Control` writer - To FB (additional CLK)"]
...
impl R {
    #[doc = "Bit 0 - To FB (additional CLK)"]
    #[inline(always)]
...
#[doc = "Gating control for FB additional clock 21\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c21_clk_gate](index.html) module"]
pub struct C21_CLK_GATE_SPEC;
impl crate::RegisterSpec for C21_CLK_GATE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c21_clk_gate::R](R) reader structure"]
impl crate::Readable for C21_CLK_GATE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c21_clk_gate::W](W) writer structure"]
impl crate::Writable for C21_CLK_GATE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets C21_CLK_GATE to value 0"]
impl crate::Resettable for C21_CLK_GATE_SPEC {
    #[inline(always)]
