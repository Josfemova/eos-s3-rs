#[doc = "Register `C01_CLK_DIV` reader"]
pub struct R(crate::R<C01_CLK_DIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C01_CLK_DIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C01_CLK_DIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C01_CLK_DIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C01_CLK_DIV` writer"]
pub struct W(crate::W<C01_CLK_DIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C01_CLK_DIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C01_CLK_DIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C01_CLK_DIV_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct C01_CLK_DIV_SPEC;
impl crate::RegisterSpec for C01_CLK_DIV_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c01_clk_div::R](R) reader structure"]
impl crate::Readable for C01_CLK_DIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c01_clk_div::W](W) writer structure"]
impl crate::Writable for C01_CLK_DIV_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets C01_CLK_DIV to value 0x11"]
impl crate::Resettable for C01_CLK_DIV_SPEC {
    #[inline(always)]
