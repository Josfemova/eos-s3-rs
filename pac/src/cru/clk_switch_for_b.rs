#[doc = "Register `CLK_SWITCH_FOR_B` reader"]
pub struct R(crate::R<CLK_SWITCH_FOR_B_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CLK_SWITCH_FOR_B_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CLK_SWITCH_FOR_B_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CLK_SWITCH_FOR_B_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CLK_SWITCH_FOR_B` writer"]
pub struct W(crate::W<CLK_SWITCH_FOR_B_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CLK_SWITCH_FOR_B_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CLK_SWITCH_FOR_B_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CLK_SWITCH_FOR_B_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "For Clock 2 (FB, A1 (Including CFGSM))\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [clk_switch_for_b](index.html) module"]
pub struct CLK_SWITCH_FOR_B_SPEC;
impl crate::RegisterSpec for CLK_SWITCH_FOR_B_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [clk_switch_for_b::R](R) reader structure"]
impl crate::Readable for CLK_SWITCH_FOR_B_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [clk_switch_for_b::W](W) writer structure"]
impl crate::Writable for CLK_SWITCH_FOR_B_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CLK_SWITCH_FOR_B to value 0"]
impl crate::Resettable for CLK_SWITCH_FOR_B_SPEC {
    #[inline(always)]
