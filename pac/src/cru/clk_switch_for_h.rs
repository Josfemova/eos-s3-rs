#[doc = "Register `CLK_SWITCH_FOR_H` reader"]
pub struct R(crate::R<CLK_SWITCH_FOR_H_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CLK_SWITCH_FOR_H_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CLK_SWITCH_FOR_H_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CLK_SWITCH_FOR_H_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CLK_SWITCH_FOR_H` writer"]
pub struct W(crate::W<CLK_SWITCH_FOR_H_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CLK_SWITCH_FOR_H_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CLK_SWITCH_FOR_H_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CLK_SWITCH_FOR_H_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct CLK_SWITCH_FOR_H_SPEC;
impl crate::RegisterSpec for CLK_SWITCH_FOR_H_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [clk_switch_for_h::R](R) reader structure"]
impl crate::Readable for CLK_SWITCH_FOR_H_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [clk_switch_for_h::W](W) writer structure"]
impl crate::Writable for CLK_SWITCH_FOR_H_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CLK_SWITCH_FOR_H to value 0"]
impl crate::Resettable for CLK_SWITCH_FOR_H_SPEC {
    #[inline(always)]
