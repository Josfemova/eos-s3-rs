...
#[doc = "Field `RELOAD` reader - Reload value. A write to this register sets the current value"]
...
#[doc = "Field `RELOAD` writer - Reload value. A write to this register sets the current value"]
...
impl R {
    #[doc = "Bits 0:31 - Reload value. A write to this register sets the current value"]
    #[inline(always)]
    pub fn reload(&self) -> RELOAD_R {
        RELOAD_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - Reload value. A write to this register sets the current value"]
