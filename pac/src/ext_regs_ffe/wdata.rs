...
#[doc = "Field `WDATA` reader - I2C slave data via WB"]
pub struct WDATA_R(crate::FieldReader<u8, u8>);
impl WDATA_R {
    #[inline(always)]
...
#[doc = "Field `WDATA` writer - I2C slave data via WB"]
...
impl R {
    #[doc = "Bits 0:7 - I2C slave data via WB"]
    #[inline(always)]
    pub fn wdata(&self) -> WDATA_R {
        WDATA_R::new((self.bits & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 0:7 - I2C slave data via WB"]
