...
#[doc = "Field `periph_id_2` reader - Peripheral identification 2"]
pub struct PERIPH_ID_2_R(crate::FieldReader<u32, u32>);
impl PERIPH_ID_2_R {
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:31 - Peripheral identification 2"]
    #[inline(always)]
    pub fn periph_id_2(&self) -> PERIPH_ID_2_R {
        PERIPH_ID_2_R::new(self.bits as u32)
    }
}
...
#[doc = "`reset()` method sets PERIPH_ID_2 to value 0x0b"]
