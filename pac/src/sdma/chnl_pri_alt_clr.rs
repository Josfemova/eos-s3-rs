...
#[doc = "Field `chnl_pri_alt_clr` writer - Set the appropriate bit to select the primary data structure for the corresponding DMA channel. Write as: \n \n Bit \\[C\\]
...
impl W {
    #[doc = "Bits 0:15 - Set the appropriate bit to select the primary data structure for the corresponding DMA channel. Write as: \n \n Bit \\[C\\]
= 0 No effect. Use the chnl_pri_alt_set Register to select the alternate data structure. \n \n Bit \\[C\\]
= 1 Selects the primary data structure for channel C. \n \n Writing to a bit where a DMA channel is not implemented has no effect."]
    #[inline(always)]
