...
pub struct RegisterBlock {
    ...
    pub subsys_dbg_mon_sel:
        crate::Reg<subsys_dbg_mon_sel::SUBSYS_DBG_MON_SEL_SPEC>,
    ...
    pub a0_pmu_dbg_mon_sel:
        crate::Reg<a0_pmu_dbg_mon_sel::A0_PMU_DBG_MON_SEL_SPEC>,
    _reserved4: [u8; 0xf0],
    ...
    pub config_mem128_aon:
        crate::Reg<config_mem128_aon::CONFIG_MEM128_AON_SPEC>,
    _reserved10: [u8; 0xfc],
