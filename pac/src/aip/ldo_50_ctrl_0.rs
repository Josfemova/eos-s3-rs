#[doc = "Register `LDO_50_CTRL_0` reader"]
pub struct R(crate::R<LDO_50_CTRL_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LDO_50_CTRL_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LDO_50_CTRL_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LDO_50_CTRL_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LDO_50_CTRL_0` writer"]
pub struct W(crate::W<LDO_50_CTRL_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LDO_50_CTRL_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LDO_50_CTRL_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LDO_50_CTRL_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum DIS_A {
    #[doc = "0: Enable LDO_50 output"]
    ENABLE = 0,
    #[doc = "1: Disable LDO_50 output"]
    DISABLE = 1,
}
...
impl<'a> DIS_W<'a> {
    ...
    #[doc = "Enable LDO_50 output"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut W {
        self.variant(DIS_A::ENABLE)
    }
    #[doc = "Disable LDO_50 output"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DISPG_A {
    #[doc = "0: Enable LDO_50 power good comparator"]
    ENABLE = 0,
    #[doc = "1: Disable LDO_50 power good comparator"]
    DISABLE = 1,
}
...
impl<'a> DISPG_W<'a> {
    ...
    #[doc = "Enable LDO_50 power good comparator"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut W {
        self.variant(DISPG_A::ENABLE)
    }
    #[doc = "Disable LDO_50 power good comparator"]
    #[inline(always)]
    pub fn disable(self) -> &'a mut W {
...
#[repr(u8)]
pub enum IMAX_A {
    #[doc = "0: Configure the maximum current for LDO_50 as 50mA"]
    MAX_50MA_CURRENT = 0,
    #[doc = "1: Configure the maximum current for LDO_50 as 30mA"]
    MAX_30MA_CURRENT = 1,
    #[doc = "2: Configure the maximum current for LDO_50 as 20mA"]
    MAX_20MA_CURRENT = 2,
    #[doc = "3: Configure the maximum current for LDO_50 as 12mA (default)"]
    MAX_12MA_CURRENT = 3,
    #[doc = "4: Configure the maximum current for LDO_50 as 8mA"]
    MAX_8MA_CURRENT = 4,
    #[doc = "5: Configure the maximum current for LDO_50 as 4mA"]
    MAX_4MA_CURRENT = 5,
    #[doc = "6: Configure the maximum current for LDO_50 as 2mA"]
    MAX_2MA_CURRENT = 6,
    #[doc = "7: Configure the maximum current for LDO_50 as 1mA"]
    MAX_1MA_CURRENT = 7,
}
...
impl IMAX_R {
    ...
    pub fn variant(&self) -> IMAX_A {
        match self.bits {
            0 => IMAX_A::MAX_50MA_CURRENT,
            1 => IMAX_A::MAX_30MA_CURRENT,
            2 => IMAX_A::MAX_20MA_CURRENT,
            3 => IMAX_A::MAX_12MA_CURRENT,
            4 => IMAX_A::MAX_8MA_CURRENT,
            5 => IMAX_A::MAX_4MA_CURRENT,
            6 => IMAX_A::MAX_2MA_CURRENT,
            7 => IMAX_A::MAX_1MA_CURRENT,
            _ => unreachable!(),
        }
    }
    #[doc = "Checks if the value of the field is `MAX_50MA_CURRENT`"]
    #[inline(always)]
    pub fn is_max_50m_a_current(&self) -> bool {
        **self == IMAX_A::MAX_50MA_CURRENT
    }
    ...
    #[doc = "Checks if the value of the field is `MAX_20MA_CURRENT`"]
    #[inline(always)]
    pub fn is_max_20m_a_current(&self) -> bool {
        **self == IMAX_A::MAX_20MA_CURRENT
    }
    ...
    #[doc = "Checks if the value of the field is `MAX_8MA_CURRENT`"]
    #[inline(always)]
    pub fn is_max_8m_a_current(&self) -> bool {
        **self == IMAX_A::MAX_8MA_CURRENT
    }
    #[doc = "Checks if the value of the field is `MAX_4MA_CURRENT`"]
    #[inline(always)]
    pub fn is_max_4m_a_current(&self) -> bool {
        **self == IMAX_A::MAX_4MA_CURRENT
    }
    #[doc = "Checks if the value of the field is `MAX_2MA_CURRENT`"]
    #[inline(always)]
    pub fn is_max_2m_a_current(&self) -> bool {
        **self == IMAX_A::MAX_2MA_CURRENT
    }
    #[doc = "Checks if the value of the field is `MAX_1MA_CURRENT`"]
    #[inline(always)]
    pub fn is_max_1m_a_current(&self) -> bool {
        **self == IMAX_A::MAX_1MA_CURRENT
    }
}
...
impl<'a> IMAX_W<'a> {
    ...
    #[doc = "Configure the maximum current for LDO_50 as 50mA"]
    #[inline(always)]
    pub fn max_50m_a_current(self) -> &'a mut W {
        self.variant(IMAX_A::MAX_50MA_CURRENT)
    }
    #[doc = "Configure the maximum current for LDO_50 as 30mA"]
    #[inline(always)]
    pub fn max_30m_a_current(self) -> &'a mut W {
        self.variant(IMAX_A::MAX_30MA_CURRENT)
    }
    #[doc = "Configure the maximum current for LDO_50 as 20mA"]
    #[inline(always)]
    pub fn max_20m_a_current(self) -> &'a mut W {
        self.variant(IMAX_A::MAX_20MA_CURRENT)
    }
    #[doc = "Configure the maximum current for LDO_50 as 12mA (default)"]
    #[inline(always)]
    pub fn max_12m_a_current(self) -> &'a mut W {
        self.variant(IMAX_A::MAX_12MA_CURRENT)
    }
    #[doc = "Configure the maximum current for LDO_50 as 8mA"]
    #[inline(always)]
    pub fn max_8m_a_current(self) -> &'a mut W {
        self.variant(IMAX_A::MAX_8MA_CURRENT)
    }
    #[doc = "Configure the maximum current for LDO_50 as 4mA"]
    #[inline(always)]
    pub fn max_4m_a_current(self) -> &'a mut W {
        self.variant(IMAX_A::MAX_4MA_CURRENT)
    }
    #[doc = "Configure the maximum current for LDO_50 as 2mA"]
    #[inline(always)]
    pub fn max_2m_a_current(self) -> &'a mut W {
        self.variant(IMAX_A::MAX_2MA_CURRENT)
    }
    #[doc = "Configure the maximum current for LDO_50 as 1mA"]
    #[inline(always)]
    pub fn max_1m_a_current(self) -> &'a mut W {
        self.variant(IMAX_A::MAX_1MA_CURRENT)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
#[repr(u8)]
pub enum DI_A {
    #[doc = "0: Configures the LDO_50 output voltage as 0.75v"]
    AS_0_75V_OUTPUT = 0,
    #[doc = "1: Configures the LDO_50 output voltage as 0.77v"]
    AS_0_77V_OUTPUT = 1,
    #[doc = "2: Configures the LDO_50 output voltage as 0.79v"]
    AS_0_79V_OUTPUT = 2,
    #[doc = "3: Configures the LDO_50 output voltage as 0.81v"]
    AS_0_81V_OUTPUT = 3,
    #[doc = "4: Configures the LDO_50 output voltage as 0.83v"]
    AS_0_83V_OUTPUT = 4,
    #[doc = "5: Configures the LDO_50 output voltage as 0.85v"]
    AS_0_85V_OUTPUT = 5,
    #[doc = "6: Configures the LDO_50 output voltage as 0.87v"]
    AS_0_87V_OUTPUT = 6,
    #[doc = "7: Configures the LDO_50 output voltage as 0.89v"]
    AS_0_89V_OUTPUT = 7,
    #[doc = "8: Configures the LDO_50 output voltage as 0.91v"]
    AS_0_91V_OUTPUT = 8,
    #[doc = "9: Configures the LDO_50 output voltage as 0.93v"]
    AS_0_93V_OUTPUT = 9,
    #[doc = "10: Configures the LDO_50 output voltage as 0.95v"]
    AS_0_95V_OUTPUT = 10,
    #[doc = "11: Configures the LDO_50 output voltage as 0.97v"]
    AS_0_97V_OUTPUT = 11,
    #[doc = "12: Configures the LDO_50 output voltage as 0.99v"]
    AS_0_99V_OUTPUT = 12,
    #[doc = "13: Configures the LDO_50 output voltage as 1.01v"]
    AS_1_01V_OUTPUT = 13,
    #[doc = "14: Configures the LDO_50 output voltage as 1.03v"]
    AS_1_03V_OUTPUT = 14,
    #[doc = "15: Configures the LDO_50 output voltage as 1.05v"]
    AS_1_05V_OUTPUT = 15,
    #[doc = "16: Configures the LDO_50 output voltage as 1.07v"]
    AS_1_07V_OUTPUT = 16,
    #[doc = "17: Configures the LDO_50 output voltage as 1.09v (default)"]
    AS_1_09V_OUTPUT = 17,
    #[doc = "18: Configures the LDO_50 output voltage as 1.11v"]
    AS_1_11V_OUTPUT = 18,
    #[doc = "19: Configures the LDO_50 output voltage as 1.13v"]
    AS_1_13V_OUTPUT = 19,
    #[doc = "20: Configures the LDO_50 output voltage as 1.15v"]
    AS_1_15V_OUTPUT = 20,
    #[doc = "21: Configures the LDO_50 output voltage as 1.17v"]
    AS_1_17V_OUTPUT = 21,
    #[doc = "22: Configures the LDO_50 output voltage as 1.19v"]
    AS_1_19V_OUTPUT = 22,
    #[doc = "23: Configures the LDO_50 output voltage as 1.21v"]
    AS_1_21V_OUTPUT = 23,
}
...
pub struct LDO_50_CTRL_0_SPEC;
impl crate::RegisterSpec for LDO_50_CTRL_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ldo_50_ctrl_0::R](R) reader structure"]
impl crate::Readable for LDO_50_CTRL_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ldo_50_ctrl_0::W](W) writer structure"]
impl crate::Writable for LDO_50_CTRL_0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets LDO_50_CTRL_0 to value 0x022c"]
impl crate::Resettable for LDO_50_CTRL_0_SPEC {
    #[inline(always)]
