#[doc = "Register `PAD_%s_CTRL_FFE` reader"]
pub struct R(crate::R<PAD__CTRL_FFE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PAD__CTRL_FFE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PAD__CTRL_FFE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PAD__CTRL_FFE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PAD_%s_CTRL_FFE` writer"]
pub struct W(crate::W<PAD__CTRL_FFE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PAD__CTRL_FFE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PAD__CTRL_FFE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PAD__CTRL_FFE_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Control selection for IO Output. 0x0 = A0 registers, 0x1 = Others, 0x2 = Fabric. * Exception - when FUNC_SEL=2, the control is from FFE\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum CTRL_SEL_A {
    #[doc = "0: A0 registers"]
...
#[doc = "Field `CTRL_SEL` reader - Control selection for IO Output. 0x0 = A0 registers, 0x1 = Others, 0x2 = Fabric. * Exception - when FUNC_SEL=2, the control is from FFE"]
...
#[doc = "Field `CTRL_SEL` writer - Control selection for IO Output. 0x0 = A0 registers, 0x1 = Others, 0x2 = Fabric. * Exception - when FUNC_SEL=2, the control is from FFE"]
...
impl R {
    ...
    #[doc = "Bits 3:4 - Control selection for IO Output. 0x0 = A0 registers, 0x1 = Others, 0x2 = Fabric. * Exception - when FUNC_SEL=2, the control is from FFE"]
    #[inline(always)]
...
pub struct PAD__CTRL_FFE_SPEC;
impl crate::RegisterSpec for PAD__CTRL_FFE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pad__ctrl_ffe::R](R) reader structure"]
impl crate::Readable for PAD__CTRL_FFE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pad__ctrl_ffe::W](W) writer structure"]
impl crate::Writable for PAD__CTRL_FFE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PAD_%s_CTRL_FFE to value 0"]
impl crate::Resettable for PAD__CTRL_FFE_SPEC {
    #[inline(always)]
