...
#[doc = "Field `TXEIS` reader - Transmit FIFO Empty Raw Interrupt Status"]
...
#[doc = "Field `TXEIS` writer - Transmit FIFO Empty Raw Interrupt Status"]
...
#[doc = "Field `TXOIS` reader - Transmit FIFO Overflow Raw Interrupt Status"]
...
#[doc = "Field `TXOIS` writer - Transmit FIFO Overflow Raw Interrupt Status"]
...
#[doc = "Field `RXUIS` reader - Receive FIFO Underflow Raw Interrupt Status"]
...
#[doc = "Field `RXUIS` writer - Receive FIFO Underflow Raw Interrupt Status"]
...
#[doc = "Field `RXOIS` reader - Receive FIFO Overflow Raw Interrupt Status"]
...
#[doc = "Field `RXOIS` writer - Receive FIFO Overflow Raw Interrupt Status"]
...
#[doc = "Field `RXFIS` reader - Receive FIFO Full Raw Interrupt Status"]
...
#[doc = "Field `RXFIS` writer - Receive FIFO Full Raw Interrupt Status"]
...
#[doc = "Field `MSTIS` reader - Multi-Master Contention Raw Interrupt Status. This bit field is not present if the SPI Master is configured as a serial-slave device."]
...
#[doc = "Field `MSTIS` writer - Multi-Master Contention Raw Interrupt Status. This bit field is not present if the SPI Master is configured as a serial-slave device."]
...
impl R {
    ...
    #[doc = "Bit 5 - Multi-Master Contention Raw Interrupt Status. This bit field is not present if the SPI Master is configured as a serial-slave device."]
    #[inline(always)]
