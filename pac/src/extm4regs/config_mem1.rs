#[doc = "Register `CONFIG_MEM1` reader"]
pub struct R(crate::R<CONFIG_MEM1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CONFIG_MEM1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CONFIG_MEM1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CONFIG_MEM1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CONFIG_MEM1` writer"]
pub struct W(crate::W<CONFIG_MEM1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CONFIG_MEM1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CONFIG_MEM1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CONFIG_MEM1_SPEC>) -> Self {
        W(writer)
    }
}
...
impl<'a> MEM2_32K_RM_W<'a> {
    ...
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        self.w.bits =
            (self.w.bits & !(0x03 << 10)) | ((value as u32 & 0x03) << 10);
        self.w
    }
}
...
impl<'a> MEM3_32K_RM_W<'a> {
    ...
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        self.w.bits =
            (self.w.bits & !(0x03 << 15)) | ((value as u32 & 0x03) << 15);
        self.w
    }
}
#[doc = "Field `MEM4_32K_DST` reader - ‘Disable-Self-Time’. When asserted high, overrides the self-timed circuitry and causes the read margin to be controlled by the falling clk edge. Requires margin\\[\\]
to be set to 2’b00. This pin is intended for debug/FA purposes only."]
pub struct MEM4_32K_DST_R(crate::FieldReader<bool, bool>);
impl MEM4_32K_DST_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        MEM4_32K_DST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MEM4_32K_DST_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `MEM4_32K_DST` writer - ‘Disable-Self-Time’. When asserted high, overrides the self-timed circuitry and causes the read margin to be controlled by the falling clk edge. Requires margin\\[\\]
to be set to 2’b00. This pin is intended for debug/FA purposes only."]
pub struct MEM4_32K_DST_W<'a> {
    w: &'a mut W,
}
impl<'a> MEM4_32K_DST_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
to be set to 2’b00. This pin is intended for debug/FA purposes only."]
    #[inline(always)]
    pub fn mem4_32k_dst(&self) -> MEM4_32K_DST_R {
        MEM4_32K_DST_R::new(((self.bits >> 19) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - Read and write margin control. Recommended setting is 2’b10. 2’b00 provides the most margin (slowest speed). 2’b11 provides the least margin (fastest speed) memory. This setting is required for VDDMIN operation."]
...
to be set to 2’b00. This pin is intended for debug/FA purposes only."]
    #[inline(always)]
    pub fn mem4_32k_dst(&mut self) -> MEM4_32K_DST_W {
        MEM4_32K_DST_W { w: self }
    }
...
#[doc = "Memory configuration register 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [config_mem1](index.html) module"]
pub struct CONFIG_MEM1_SPEC;
impl crate::RegisterSpec for CONFIG_MEM1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [config_mem1::R](R) reader structure"]
impl crate::Readable for CONFIG_MEM1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [config_mem1::W](W) writer structure"]
impl crate::Writable for CONFIG_MEM1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CONFIG_MEM1 to value 0x0001_0842"]
impl crate::Resettable for CONFIG_MEM1_SPEC {
    #[inline(always)]
